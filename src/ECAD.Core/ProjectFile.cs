...
public static class ProjectFile
{
    ...
    {
        if (document.SchemaVersion is < 1 or > 10) throw new InvalidDataException("Непідтримувана версія документа.");
        document = document with { SchemaVersion = 10, Elements = DrivingDimensions.ApplyAll(document.Elements) };
        document.Validate();
