...
Це специфікація цільового UI. Основну оболонку впроваджено у 0.19: command/panel registries, вкладки, перенесення між областями, інспектор кількох об’єктів, бібліотечна та ERC-навігація, light/dark ресурси й headless HiDPI. Точний реалізований обсяг і невиконані ручні перевірки — [RELEASE-0.19](RELEASE-0.19.md). Нижче лишаються цільові вимоги; їх наявність у документі не означає виконане ручне приймання.
...
Приймання у PLAN спирається на сценарії: намалювати мишею і числом; вибрати групу; змінити спільну властивість; знайти символ і вставити; перейти ERC→аркуш→об'єкт; save/open; undo/redo; сховати/повернути панелі. Потрібні headless focus/command tests та ручні прогони Windows/Ubuntu при 100/150/200%, вузькому вікні й українських довгих назвах. У 0.19 використано власний невеликий host на Avalonia Grid/TabControl без додаткової docking library; плаваючі панелі не впроваджено.
